...
namespace AgglomerativeClustering
{
    class Pairwise
    {
        private static double[] CalcPairwise(List<BiCluster> clusters, Similarity similarity, int startIdx, int endIdx, float[][] cache, int offset)
        {
        ...
        public static double[] FindNearestPair(int numThreads, List<BiCluster> clusters, Similarity similarity, float[][] cache, int offset, long duration)
        {
        ...
        private static List<double[]> RunThreads(int numThreads, int[,] indexes, List<BiCluster> clusters, Similarity similarity, float[][] cache, int offset)
        {
