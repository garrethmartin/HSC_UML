...
namespace GNG
{
    public class Graph
    {
        ...
        public GraphNode AddNode(float[] position, int iteration, double cum_error = 0)
        {
            int lastUpdate = iteration - 1;

            GraphNode newNode = new GraphNode(id: insertNodeCount, lastUpdate: lastUpdate);
            newNode.cum_error = cum_error;
        ...
        public GraphEdge addEdge(GraphNode head, GraphNode tail, int age = 0)
        {
            var edge = new GraphEdge(head, tail);
