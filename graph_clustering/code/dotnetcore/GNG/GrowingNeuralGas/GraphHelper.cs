...
namespace GNG
{
    public class GraphHelper
    {
        ...
        public List<float[]> GetClusterCenters()
        {
            ...
            int[,] nodeClusterIndex = GetNodeClusterIndex(clusters);
        ...
        public List<double[]> GetNodeInfo()
        {
            var nodeInfos = new List<double[]>();
            ...
            {
                GraphNode node = this.g.getNode(nodeIndex);
                double[] info = new double[] { node.cum_error, node.lastUpdate };
                nodeInfos.Add(info);
            }
        ...
        public static List<int[]> GetDatapointClusterIndexVQ(List<float[]> samples, List<int[]> nodeClusterIndex, List<float[]> positionsList, int maxThreads = 2, int metric = 1)
        {
        ...
        public int[,] GetEdgeIndex()
        {
            ...
            int[,] edgeIndex = new int[edges.Count, 3];
